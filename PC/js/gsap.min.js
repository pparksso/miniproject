...
!(function (t, e) {
  ...
  function Vk(t) {
    var e,
      ...
      s = !0 === t;
    if (
      (k < a && (A += a - C), (0 < (e = (i = (D += a) - A) - z) || s) && ((n = ++T.frame), (b = i - 1e3 * T.time), (T.time = i /= 1e3), (z += e + (S <= e ? 4 : S - e)), (r = 1)), s || (m = g(Vk)), r)
    )
          ...
          this._onUpdate && !e && Ot(this, "onUpdate", !0),
            ((v === m && this._tTime >= this.totalDuration()) || (!v && c)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                ...
                e || (t < 0 && !c) || (!v && !c && m) || (Ot(this, v === m && 0 <= t ? "onComplete" : "onReverseComplete", !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
        ...
        if (((c = (l = S[0] ? _(S[0]).harness : 0) && g[l.prop]), (i = oa(g, ut)), D && (ta(D.render(-1, !0)), (D._lazy = 0)), y))
          if (
            (ta(
              (e._startAt = $t.set(
                S,
                ka({ data: "isStart", overwrite: !1, parent: z, immediateRender: !0, lazy: t(b), startAt: null, delay: 0, onUpdate: w, onUpdateParams: x, callbackScope: k, stagger: 0 }, y)
              ))
            ),
  ...
  var $t = (function (R) {
    ...
    return (
        ...
        if (p) {
          ...
          !(function _renderZeroDurationTween(t, e, r, i) {
            ...
            if (
              (h &&
                t._repeat &&
                ((l = bt(0, t._tDur, e)), (a = gt(l, h)), t._yoyo && 1 & a && (u = 1 - u), a !== gt(t._tTime, h) && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
      ...
      (e.invalidate = function invalidate() {
        return (
          (this._pt = this._op = this._startAt = this._onUpdate = this._lazy = this.ratio = 0), (this._ptLookup = []), this.timeline && this.timeline.invalidate(), R.prototype.invalidate.call(this)
        );
      }),
          ...
          if ("autoRound" !== d && ((s = e[d]), !ft[d] || !Ub(d, e, r, i, t, n)))
            if (((l = typeof s), (f = Ge[d]), "function" === l && (l = typeof (s = s.call(r, i, t, n))), "string" === l && ~s.indexOf("random(") && (s = hb(s)), f)) f(this, t, d, s, r) && (T = 1);
              ...
              if (
                ...
                (u = parseFloat(s)),
                d in qe &&
                  ("autoAlpha" === d && (1 === h && "hidden" === Fd(t, "visibility") && u && (h = 0), Cd(this, w, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)),
  ...
  (he.utils.checkPrefix = je),
    (ur = ba(
      (sr = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (or = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective",
      function (t) {
        Fe[t] = 1;
      }
    )),
